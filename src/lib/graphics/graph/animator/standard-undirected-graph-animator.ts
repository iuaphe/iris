...
import type { UndirectedGraphAnimator } from './undirected-graph-animator';
...
export class StandardUndirectedGraphAnimator<V> implements UndirectedGraphAnimator<V> {
	...
	constructor(
		...
		private graph: UndirectedGraph<V>,
