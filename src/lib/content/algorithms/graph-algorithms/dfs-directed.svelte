<script lang="ts">
	...
	import { Stack } from './search/fringe';
	import { directedWally } from '$lib/graphics/graph/presets';
	import { DirectedFringeSearch } from './search/directed-fringe';

	// @hmr:reset
	let canvas: HTMLCanvasElement;
	let context: CanvasRenderingContext2D;
	let primative: PrimativeDrawer;
	let graph: DirectedGraphAnimator<number>;
	...
	onMount(() => {
		...
		graph = directedWally(primative, canvas, false);

		algorithm = new DirectedFringeSearch(graph, () => new Stack());
